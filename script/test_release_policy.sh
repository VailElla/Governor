...
assert_contains "$VERSION_FILE" "GOVERNOR_VERSION=0.2.3"
assert_contains "$VERSION_FILE" "GOVERNOR_BUILD_NUMBER=7"
assert_contains "$VERSION_FILE" "GOVERNOR_RELEASE_TAG=v0.2.3"
